...
import profileImage from "./images/lucid.jpg";
import { decode } from "blurhash";

// 외부에서 불러온 이미지는 placeholder="blur"에 대한 추가적인 데이터가 필요함
    ...
    <>
      <div className="flex gap-4">
        <Image
          ...
          placeholder="blur"
          className="w-[128px]"
          // 기본 값은 lazy이며, 뷰포트 위치 상관 없이 바로 불러올 필요가 있다면 eager로 설정
          loading="lazy"
          // true로 안 하고, 대부분의 경우 lazy를 eager로 설정해도 됨
          preload={false}
        />
        <Image
          src="https://i.namu.wiki/i/Xk2F7c9ug5fVBKKTE89kTGvfzTO55k-YeQlbdPYb_fAcGIbpCLSjngJopgx4U8adflVDV85vNKWGBG1Ug6cezw.webp"
          alt="Profile"
          width={256}
          height={256}
          className="w-[128px] object-cover"
          placeholder="blur"
          blurDataURL={blurHashToDataURL("LPRe{vn%*JkpwOo0s;X8%jozvORP")}
        />
      </div>
      <div>
        <figure>
          <picture>
            <source
              ...
              srcSet="https://i.namu.wiki/i/Xk2F7c9ug5fVBKKTE89kTGvfzTO55k-YeQlbdPYb_fAcGIbpCLSjngJopgx4U8adflVDV85vNKWGBG1Ug6cezw.webp"
              width={128}
              height={128}
              className="w-[128px] object-cover"
            />
            <source
              ...
              srcSet="https://i.ytimg.com/vi/0vasgueaCyY/maxresdefault.jpg"
              width={128}
              height={128}
              className="w-[128px] object-cover"
            />
