...
})({"gNemz":[function(require,module,exports) {
...
async function newsFeed() {
  ...
  `;
    for (const feed of newsFeed)// DOM 구조가 잘 보이지 않는 것을, DOM API가 아닌, 문자열만 사용해 만듦으로써 보여줌
    // 의외로 createElement 등으로 관계를 만들어가는 것보다 구조에 대한 가독성이 좋음
    newsList.push(`
      <div class="p-6 ${feed.read ? "bg-red-500" : "bg-white"} mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100">
        <div class="flex">
          <div class="flex-auto">
...
},{}]},["gNemz","igcvL"], "igcvL", "parcelRequire84d7")
